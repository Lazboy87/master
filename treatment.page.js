export default{
    ...
    <div class="mainContainer">
        ...
        <img v-on:click="seen = !seen" class="Images" id="img1" src="Images/fillerPicForQuestionMark119-364x364.jpg"/>
        </div>

            <div v-if="seen" class="testPopup">
            <p v-if="seen">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
        
        <div class="routerContainer">
        <router-link to="/dateoso" class="elLink">Osteopati</router-link>
        <img v-on:click="seen2 = !seen2" class="Images" id="img2" src="Images/fillerPicForQuestionMark119-364x364.jpg"/>
        </div>

            <div v-if="seen2" class="testPopup">
        ...
        <img v-on:click="seen3 = !seen3" class="Images" id="img3" src="Images/fillerPicForQuestionMark119-364x364.jpg"/>
        </div>

            <div v-if="seen3" class="testPopup">
        ...
        <img v-on:click="seen4 = !seen4" class="Images" src="Images/fillerPicForQuestionMark119-364x364.jpg"/>
        </div>
            <div v-if="seen4" class="testPopup">
    ...
    //<img class="Images" src="Images/fillerPicForQuestionMark119-364x364.jpg"/>